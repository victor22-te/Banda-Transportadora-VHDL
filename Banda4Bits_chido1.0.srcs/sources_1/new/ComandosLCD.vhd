...
-- LINEA 3 (direcciones 0x14-0x27 en LCD 20x4)
ELSIF DATO2 = 3 AND DATO3 = 1  THEN RETURN '1'&x"78";
ELSIF DATO2 = 3 AND DATO3 = 2  THEN RETURN '1'&x"79";
ELSIF DATO2 = 3 AND DATO3 = 3  THEN RETURN '1'&x"7A";
ELSIF DATO2 = 3 AND DATO3 = 4  THEN RETURN '1'&x"7B";
ELSIF DATO2 = 3 AND DATO3 = 5  THEN RETURN '1'&x"A0";
ELSIF DATO2 = 3 AND DATO3 = 6  THEN RETURN '1'&x"A1";
ELSIF DATO2 = 3 AND DATO3 = 7  THEN RETURN '1'&x"A2";
ELSIF DATO2 = 3 AND DATO3 = 8  THEN RETURN '1'&x"A3";
ELSIF DATO2 = 3 AND DATO3 = 9  THEN RETURN '1'&x"A4";
ELSIF DATO2 = 3 AND DATO3 = 10 THEN RETURN '1'&x"A5";
ELSIF DATO2 = 3 AND DATO3 = 11 THEN RETURN '1'&x"A6";
ELSIF DATO2 = 3 AND DATO3 = 12 THEN RETURN '1'&x"A7";
ELSIF DATO2 = 3 AND DATO3 = 13 THEN RETURN '1'&x"A8";
ELSIF DATO2 = 3 AND DATO3 = 14 THEN RETURN '1'&x"A9";
ELSIF DATO2 = 3 AND DATO3 = 15 THEN RETURN '1'&x"AA";
ELSIF DATO2 = 3 AND DATO3 = 16 THEN RETURN '1'&x"AB";
ELSIF DATO2 = 3 AND DATO3 = 17 THEN RETURN '1'&x"AC";
ELSIF DATO2 = 3 AND DATO3 = 18 THEN RETURN '1'&x"AD";
ELSIF DATO2 = 3 AND DATO3 = 19 THEN RETURN '1'&x"AE";
ELSIF DATO2 = 3 AND DATO3 = 20 THEN RETURN '1'&x"AF";
-- LINEA 4 (direcciones 0x54-0x67 en LCD 20x4)
ELSIF DATO2 = 4 AND DATO3 = 1  THEN RETURN '1'&x"B0";
ELSIF DATO2 = 4 AND DATO3 = 2  THEN RETURN '1'&x"B1";
ELSIF DATO2 = 4 AND DATO3 = 3  THEN RETURN '1'&x"B2";
ELSIF DATO2 = 4 AND DATO3 = 4  THEN RETURN '1'&x"B3";
ELSIF DATO2 = 4 AND DATO3 = 5  THEN RETURN '1'&x"B4";
ELSIF DATO2 = 4 AND DATO3 = 6  THEN RETURN '1'&x"B5";
ELSIF DATO2 = 4 AND DATO3 = 7  THEN RETURN '1'&x"B6";
ELSIF DATO2 = 4 AND DATO3 = 8  THEN RETURN '1'&x"B7";
ELSIF DATO2 = 4 AND DATO3 = 9  THEN RETURN '1'&x"B8";
ELSIF DATO2 = 4 AND DATO3 = 10 THEN RETURN '1'&x"B9";
ELSIF DATO2 = 4 AND DATO3 = 11 THEN RETURN '1'&x"BA";
ELSIF DATO2 = 4 AND DATO3 = 12 THEN RETURN '1'&x"BB";
ELSIF DATO2 = 4 AND DATO3 = 13 THEN RETURN '1'&x"BC";
ELSIF DATO2 = 4 AND DATO3 = 14 THEN RETURN '1'&x"BD";
ELSIF DATO2 = 4 AND DATO3 = 15 THEN RETURN '1'&x"BE";
ELSIF DATO2 = 4 AND DATO3 = 16 THEN RETURN '1'&x"BF";
ELSIF DATO2 = 4 AND DATO3 = 17 THEN RETURN '1'&x"C0";
ELSIF DATO2 = 4 AND DATO3 = 18 THEN RETURN '1'&x"C1";
ELSIF DATO2 = 4 AND DATO3 = 19 THEN RETURN '1'&x"C2";
ELSIF DATO2 = 4 AND DATO3 = 20 THEN RETURN '1'&x"C3";
ELSE RETURN '1'&x"77";
END IF;
END POS;
-------------------------------------------------
